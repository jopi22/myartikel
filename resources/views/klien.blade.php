                ...
                <article class="article article-style-c">
                    <div class="article-header">
                        <a href="{{ url('detail', $hasil->id) }}">
                            <img src="{{ asset($hasil->gambar) }}" alt="">
                        </a>
                    </div>
                    <div class="article-details">
                        <div class="article-category"><a href="#">{{ $hasil->category->name }}</a>
                            <div class="bullet"></div> <a href="#">{{ $hasil->created_at->diffforHumans() }}</a>
                        </div>
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        @foreach ($data1 as $hasil)
                            <li class="media">
                                <a href="{{ url('detail', $hasil->id) }}">
                                    <img class="mr-3" src="{{ asset($hasil->gambar) }}" style="width: 200px"
                ...
                @foreach ($category as $hasil)
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center"> <a
                                href="{{ url('list_kategori') }}">{{ $hasil->name }}</a>
